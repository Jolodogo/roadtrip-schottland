      ...
      <div style="padding: 12px;">
        ...
        <div style="margin-top:10px;display:flex;gap:8px;">
          ...
          <button
            ...
            style="flex:1;background:#14532d;border:1px solid #166534;color:#86efac;font-size:12px;padding:6px 10px;border-radius:8px;cursor:pointer;text-align:left;display:flex;align-items:center;gap:6px;"
